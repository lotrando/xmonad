...
```
wget https://gentoo.osuosl.org//releases/amd64/autobuilds/current-stage3-amd64-openrc/stage3-amd64-openrc-20231105T170200Z.tar.xz
```

#### another mirror

```
wget https://gentoo.c3sl.ufpr.br//releases/amd64/autobuilds/current-stage3-amd64-openrc/stage3-amd64-openrc-20231105T170200Z.tar.xz
```

```
tar xpf stage3-amd64-openrc-20231105T170200Z.tar.xz --xattrs-include='*.*' --numeric-owner
```
